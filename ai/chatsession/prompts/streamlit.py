...
class MentalHealthPrompt(BasePropmtTemplates):
    CHAT_TEMPLATE = """The following is a friendly conversation between a human and an AI Therapist. The AI is friendly and supportive to the human. The AI's responses should prioritize the well-being of the human and avoid saying anything harmful.
...
"""    
    ...
    DEVELOPMENT_SUMMARY_TEMPLATE = """This is a conversation between a patient and an AI Therapist. 
