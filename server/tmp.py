...
conv_list = ["AI: Hello Pandora, my name is AIDE, and I'm here to assist and chat with you. I heard you have a green thumb – any favorite memories from your gardens in the past that bring a smile to your face?",
...
def turn_to_dict(conv_list):
    out = []
    for line in conv_list:
        print(line)
        actor, msg = line.replace("\n", "").split(":")
        msg = msg.strip()
        actor = actor.strip()
        out.append({
            "content": {actor.lower(): msg,}
        })

    print(out)

turn_to_dict(conv_list)
